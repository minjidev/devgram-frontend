...
export default function FeedWriteView() {
  ...
  `;
    ...
    return (
        <div>
            {EquiModal ? (
                <div className="fixed w-full h-full bg-black z-40 opacity-70"></div>
            ) : null}
            <Navigation />
            <div className="text-black mt-12">
                <div className="m-auto w-[700px]">
                    <iframe
                        src="#"
                        name="iframe"
                        className="w-px h-px border-0 invisible"
                    ></iframe>
                    <form
                        action="http://localhost:3001/board"
                        method="post"
                        target="iframe"
                    >
                        {/* 공지 */}
                        ...
                        <div className="intro">
                            <FeedWriteFile
                                title="자기소개"
                                mandatory={true}
                                guide="자기소개를 입력 해주세요 (블로그, SNS, 깃헙주소 등을 적으셔도 됩니다)"
                                name="intro"
                                explain="자기소개"
                                target={setTarget1}
                            />
                        ...
                        <div className="recommend">
                            <FeedWriteQue
                                title="추천하는 이유"
                                mandatory={true}
                                guide="추천한 장비에 대한 장점을 적어주세요, 가성비나 외형, 기능 등을 자유롭게 적어주시면 됩니다."
                                name="recommend"
                                explain="장비를 추천하는 이유"
                                target={setTarget2}
                            />
                        ...
                        <div className="best">
                            <FeedWriteQue
                                title="베스트 장비"
                                guide="추천한 장비중 하나를 골라, 타 장비와 차별화 된 장점을 적어주세요."
                                name="best"
                                explain="하나의 베스트 장비를 이유와 함께"
                            />
                        </div>
                        ...
                        <div className="etc">
                            <FeedWriteQue
                                title="기타 추천 장비"
                                guide="위에선 선택하지 않았지만 추천할만한 장비들을 적어주세요, 추천 장비와 어울리는 보조장비를 적어주셔도 좋습니다."
                                name="etc"
                                explain="추천할만한 보조장비들"
                            />
                        </div>
                        ...
                        <div className="last">
                            <FeedWriteQue
                                title="마지막"
                                guide="마지막으로 적으실 말을 자유롭게 작성해주세요."
                                name="last"
                                explain="마지막으로 자유롭게 내용"
                            />
                        </div>
                        ...
                        <div className="title mt-6">
                            ...
                            <input
                                type="text"
                                className="text-4xl bg-white outline-none border-b-2 border-gray-300 w-full"
                        ...
                        <div className="btn-box flex flex-row-reverse mt-10">
                            <Btn onClick={handlerModalBtn} type="button">
                                작성
                            </Btn>
                            {modalOpen === true ? (
                                <FeedWriteModal setModalOpen={setModalOpen} />
                            ) : null}
                            {EquiModal === true ? (
                                <EquipmentModal
                                    Open={setEquiModal}
